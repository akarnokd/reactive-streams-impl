 ...
 *
 */
public final class MpscLinkedQueue<T> extends BaseLinkedAtomicQueue<T> {

    public MpscLinkedQueue() {
        super();
        LinkedQueueAtomicNode<T> node = new LinkedQueueAtomicNode<>();
        spConsumerNode(node);
    ...
    public final boolean offer(final T nextValue) {
        final LinkedQueueAtomicNode<T> nextNode = new LinkedQueueAtomicNode<>();
        final LinkedQueueAtomicNode<T> prevProducerNode = xchgProducerNode(nextNode);
    ...
    @Override
    public final T poll() {
        LinkedQueueAtomicNode<T> currConsumerNode = lpConsumerNode(); // don't load twice, it's alright
        LinkedQueueAtomicNode<T> nextNode = currConsumerNode.lvNext();
        if (nextNode != null) {
